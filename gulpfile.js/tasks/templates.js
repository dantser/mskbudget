...
gulp.task('templates', () => (
  gulp.src('app/**/*.pug')
  // gulp.src(['app/pages/budget_income/budget_income.pug', 'app/pages/budget_expenses/budget_expenses.pug', 'app/pages/budget_moscow_sources/budget_moscow_sources.pug'])
