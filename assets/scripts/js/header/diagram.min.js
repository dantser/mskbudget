...
(function() {
    ...
    Diagram.prototype.segmentDiagram = function() {
        ...
        for (var i = 0; i < _.options.data.length; i++) {
			...
			if (degrees >= 270) highdegrees = true;
			...
			if (highdegrees) {
				_.x1 = Math.cos( (_.startAngle + 270) * _.rad ) * (radius-_.options.padding) + (_.options.viewBox / 2);
				_.y1 = Math.sin( (_.startAngle + 270) * _.rad ) * (radius-_.options.padding) + (_.options.viewBox / 2);
			}
