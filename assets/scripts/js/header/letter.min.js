...
! function() {
    ...
    t.prototype.getParam = function() {
        ...
        }),*/ n.slider.siblings(".letter__hover").mouseenter(function() {
            //var e = $(this).attr("data-direct");
            //r = setInterval(function() {
            //    var offs = 100;
            //    "left" == e ? (offs = -100) : "right" == e && t("right");
            //    var offs = 100;
            //    $('.letter__slider').animate({
            //      scrollLeft: +=offs,
            //    })
            //    console.log('interval active');
            //}, 321)
        }), n.slider.siblings(".letter__hover").mouseleave(function() {
            //clearInterval(r);
...
$('.letter__hover').hover(function(e) {
  var container = $(this).parent().find('.letter__slider');

  if ($(this).hasClass('letter__hover_left')) {
    var direction = function() {
      container.stop().animate({
        scrollLeft: '-=100'
      }, 250, 'linear', direction);
    }
    container.stop().animate({
      scrollLeft: '-=100'
    }, 250, 'linear', direction);
