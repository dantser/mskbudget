...
! function() {
    ...
    t.prototype.getParam = function() {
        ...
        this.track.css("left", t).attr("data-offset-left", t)
        ...
        var t = this;
        t.itemCount = t.slider.find(".letter__item").length, t.startLeft = ($(window).width() - t.line.width()) / 2, t.track.width(t.itemWidth * t.itemCount).css("left", t.startLeft).attr("data-offset-left", t.startLeft), t.Line(!0)
    }, letter = function(e, i) {
        new t(e, i)
    }
}();
