...
$(document).ready(function() {
  ...
  $("#whitescreen").fadeOut(521);
    ...
    $(".header__open-menu").click(function() {
        var e = $(this);
        return e.hasClass("act") ? ($(".header__drop").fadeOut(321), e.removeClass("act"), $(".header").removeClass("header_opened"), $(".sections, .guide").removeClass("filter_blur")) : ($(".header__drop").fadeIn(321), e.addClass("act"), $(".header").addClass("header_opened"), $(".sections, .guide").addClass("filter_blur")), !1
    }), e > 700 && !$(".sections").hasClass("sections_fs") && $(window).scroll(function() {
        var e = $(this).scrollTop();
        e > 21 ? $(".header").addClass("header_short") : $(".header").removeClass("header_short")
