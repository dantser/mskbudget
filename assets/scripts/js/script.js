    ...
    if ($carousel.length) {
        if ($(window).width() > 1000) {
            ...
            var $carousel_count = $(".carousel-count", $carousel),
                ...
                $ar_right = $(".ar-right", $carousel),
                carousel_data = $("carousel-3d slide", $carousel).clone(),
                carousel_html = "",
                touchstart_pos = null,
                touchend_pos = null;
...
$("body").on("click", ".carousel-area__right__zone", function (event) {
...
$("body").on("click", ".carousel-area__left__zone", function (event) {
...
budget.extend("whatIsBudgetWeight", {
        init: function init() {
                ...
                this.elements.$characteristic.on("click", ".whatIsBudget-characteristic__termin", function (event) {
                        ...
                        $(this).parents('.whatIsBudget-characteristic__wrapper').find('.whatIsBudget-characteristic.active').removeClass('active');
                        $(this).parents('.whatIsBudget-characteristic').addClass('active');
...
$('.budgetScales-activeZone._balance').hover(function(){
    $('.whatIsBudget-characteristic._balance .whatIsBudget-characteristic__termin').click();
});
...
//
function expendituresTitleFake(){
    $('.whatIsBudget-expenditures__title-fake').click(function(){
        if($(this).hasClass('_active')){
            $(this).removeClass('_active');
        }
        else{
            $('.whatIsBudget-expenditures__title._active').removeClass('_active');
            $('.whatIsBudget-expenditures__title-fake._active').removeClass('_active');
            $(this).addClass('_active');
        }
        $('.whatIsBudget-expenditures__title[data-item="' + $(this).data('item') + '"]').trigger('click');
    });
}
