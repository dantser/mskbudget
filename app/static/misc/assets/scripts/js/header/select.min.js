    ...
    $(".range-datepicker__item").length > 0 && ($(".range-datepicker__item").datepicker({
        ...
        onSelect: function(e, t) {
          ...
          // $('.range-datepicker__item_max').find('.ui-datepicker-next').click();
            ...
            "max" == a ? ($("#" + n + " .input-max").val(e), $(".range-datepicker").fadeOut(321), $(".range-datepicker__item_min, .range-datepicker__item_max").removeAttr("style"), $(".input-max").removeClass("focused"), $(".form__date-range").removeClass("form__date-range_focus"), $(".range-datepicker__item_min").datepicker("option", {
                maxDate: e
            })) : "min" == a && ($("#" + n + " .input-min").val(e), $(this).fadeOut(321).next().fadeIn(321), $("#rid-0").children(".input-max").addClass("focused"), $(".range-datepicker__item_max").datepicker("option", {
                minDate: e
