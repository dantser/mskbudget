...
$(document).ready(function() {
  ...
  $(document).on('focus', ".jq-f-datepicker", function(e) {
    ...
    rangeDatepickerInit('.range-datepicker__item', '', '');
    ...
    $(".jq-f-datepicker").length > 0 && ($(".form__date-range").each(function(e) {
        ...
        var t = $(this),
            ...
            a = (t.parent().offset().left) - s.offset().left,
            n = (t.parent().offset().top) - (s.offset().top - 35),
	...
	/*$(document).on("click", ".datepicker__col_years a", function() {
		...
		var panel = $(this).parents('.datepicker__panel');
        if (!$(this).hasClass("datepicker__a_dis")) {
			...
			$(this).parents('.datepicker__col_years').addClass('changed');
			if (panel.find('.datepicker__col_months.changed').length) {
				panel.slideUp(321).prev().removeClass("datepicker__show_act");
				panel.find('.changed').removeClass('changed');
			}
        }
        return !1
    }), */
	...
	/*$(document).on("click", ".datepicker__col_months a", function() {
        ...
        if (!$(this).hasClass("datepicker__a_dis")) {
			...
			$(this).parents('.datepicker__col_months').addClass('changed');
			if (panel.find('.datepicker__col_years.changed').length) {
				panel.slideUp(321).prev().removeClass("datepicker__show_act");
				panel.find('.changed').removeClass('changed');
			}
        }
