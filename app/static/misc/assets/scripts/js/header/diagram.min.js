...
(function() {
    ...
    Diagram.prototype.tripleDiagram = function() {
		...
		var _ = this, radius, diff, degrees, val, path = [], radiusArr = [], valArr = [];
    ...
    Diagram.prototype.createSvg = function(path){
        ...
        if( _.options.kind == 'triple' ){
			...
			var defProfPathVal = parseInt(path.val[0]), colors, defProfNumClass;
			
			if (defProfPathVal < 0) {
				colors = ['#30B069', '#FEE300'];
				defProfNumClass = 'comp-diagram__num_yellow';
			} else {
				colors = ['#FEE300', '#30B069'];
				defProfNumClass = 'comp-diagram__num_yellow comp-diagram__num_pos';
			}

            values = '<div class="comp-diagram__values"><div id="value-path-'+ _.element +'-2" class="comp-diagram__num comp-diagram__num_blue diagram-value" data-value="'+ path.val[2] +'">'+ path.val[2] +'</div><div id="value-path-'+ _.element +'-1" class="comp-diagram__num comp-diagram__num_pink diagram-value" data-value="'+ path.val[1] +'">'+ path.val[1] +'</div><div id="value-path-'+ _.element +'-0" class="comp-diagram__num '+defProfNumClass+' diagram-value" data-pre-val="'+ path.preV +'" data-value="'+ path.val[0] +'">'+ path.val[0] +'</div></div>';
            ...
            svgBody += '<filter id="f1"><feGaussianBlur stdDeviation="5"/></filter><defs><linearGradient xmlns="http://www.w3.org/2000/svg" id="svg-gradient_'+ _.element +'-0" gradientUnits="userSpaceOnUse" x1="'+ _.x0 +'" y1="'+ _.y0 +'" x2="'+ _.x1 +'" y2="'+ _.y1 +'"><stop offset="0" style="stop-color:'+colors[0]+'"/><stop offset="1" style="stop-color:'+colors[1]+'"/></defs><defs></linearGradient><linearGradient xmlns="http://www.w3.org/2000/svg" id="svg-gradient_'+ _.element +'-1" gradientUnits="userSpaceOnUse" x1="224.0493" y1="185.9902" x2="54.2576" y2="87.9609"><stop offset="0.1748" style="stop-color:#9D308A"/><stop offset="1" style="stop-color:#FF695B"/></linearGradient></defs><defs><linearGradient id="svg-gradient_'+ _.element +'-2" gradientUnits="userSpaceOnUse" x1="51.5933" y1="241.0088" x2="241.0492" y2="51.5528"><stop offset="0" style="stop-color:#00FFFF"></stop><stop offset="1" style="stop-color:#004CCF"></stop></linearGradient></defs>';
        ...
        if( _.options.kind == 'triple2' ){
            ...
            values = '<div class="comp-diagram__values"><div id="value-path-'+ _.element +'-2" class="comp-diagram__num comp-diagram__num_blue diagram-value" data-value="'+ path.val[2] +'+100">'+ path.val[2]  +' +100.0' +'</div><div id="value-path-'+ _.element +'-1" class="comp-diagram__num comp-diagram__num_pink diagram-value" data-value="'+ path.val[1] +'">'+ path.val[1] +' +100.0'  +'</div><div id="value-path-'+ _.element +'-0" class="comp-diagram__num '+defProfNumClass+' diagram-value" data-pre-val="'+ path.preV +'" data-value="'+ path.val[0] +'">'+ path.val[0] +' +100.0'  +'</div></div>';
