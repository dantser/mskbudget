...
(function() {
    ...
    Diagram.prototype.createSvg = function(path){
        ...
        if( _.options.kind == 'triple' ){
			...
			var defProfPathVal = parseInt(path.val[0]), colors;
            ...
            svgBody += '<filter id="f1"><feGaussianBlur stdDeviation="5"/></filter><defs><linearGradient xmlns="http://www.w3.org/2000/svg" id="svg-gradient_'+ _.element +'-0" gradientUnits="userSpaceOnUse" x1="'+ path.coords[2][2] +'" y1="'+ path.coords[2][3] +'" x2="'+ path.coords[0][2] +'" y2="'+ path.coords[0][3] +'"><stop offset="0" style="stop-color:'+colors[0]+'"/><stop offset="1" style="stop-color:'+colors[1]+'"/></defs><defs></linearGradient><linearGradient xmlns="http://www.w3.org/2000/svg" id="svg-gradient_'+ _.element +'-1" gradientUnits="userSpaceOnUse" x1="224.0493" y1="185.9902" x2="54.2576" y2="87.9609"><stop offset="0.1748" style="stop-color:#9D308A"/><stop offset="1" style="stop-color:#FF695B"/></linearGradient></defs><defs><linearGradient id="svg-gradient_'+ _.element +'-2" gradientUnits="userSpaceOnUse" x1="51.5933" y1="241.0088" x2="241.0492" y2="51.5528"><stop offset="0" style="stop-color:#00FFFF"></stop><stop offset="1" style="stop-color:#004CCF"></stop></linearGradient></defs>';
