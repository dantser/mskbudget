...
(function() {
    ...
    Diagram.prototype.createSvg = function(path){
        ...
        if( _.options.kind == 'triple2' ){
            ...
            values = '<div class="comp-diagram__values"><div id="value-path-'+ _.element +'-2" class="comp-diagram__num comp-diagram__num_blue diagram-value" data-value="'+ path.val[2] +'">'+ path.val[2]  +' +100.0' +'</div><div id="value-path-'+ _.element +'-1" class="comp-diagram__num comp-diagram__num_pink diagram-value" data-value="'+ path.val[1] +'">'+ path.val[1] +' +100.0'  +'</div><div id="value-path-'+ _.element +'-0" class="comp-diagram__num comp-diagram__num_yellow diagram-value" data-pre-val="'+ path.preV +'" data-value="'+ path.val[0] +'">'+ path.val[0] +' +100.0'  +'</div></div>';
