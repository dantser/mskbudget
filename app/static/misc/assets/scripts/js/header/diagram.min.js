...
(function() {
    ...
    Diagram.prototype.ifiniteDiagram = function() {
        ...
        val = _.options.data[0];
        path.faktVal = val.toFixed(1).replace('.', ',');
    ...
    if( _.options.kind == 'ifinite' ){
        ...
        values = '<div class="large-diagram__values"><div class="large-diagram__percent"><span id="value-perc-path-'+ _.element +'-0" class="diagram-value" data-value="'+ path.percVal +'">'+ path.percVal +'</span>%</div><div class="large-diagram__value large-diagram__value_top">план<p class="'+ _.options.valClass[0] +'">'+ _.options.maxValue.toFixed(1).replace('.', ',') +'</p></div><div class="large-diagram__value large-diagram__value_bottom"><p id="value-path-'+ _.element +'-0" class="'+ _.options.valClass[1] +' diagram-value" data-value="'+ path.faktVal +'">'+ path.faktVal +'</p>факт</div></div>';
                    ...
                    for (var i = 0; i < v.length; i++) {
                        ...
                        if (v[i]) {
                            if (!last) {
                                ...
                                valueItem[i].html(curValue[i].toFixed(1).replace('.',','));
                            } else {
