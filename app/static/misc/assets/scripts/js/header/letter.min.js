...
! function() {
    ...
    t.prototype.getParam = function() {
        ...
        var t = this;
        t.itemCount = t.slider.find(".letter__item").length, t.startLeft = ($(window).width() - t.line.width()) / 2, t.track.width(t.itemWidth * t.itemCount).css("margin-left", t.startLeft).css("padding-right", t.startLeft).attr("data-offset-left", t.startLeft), t.Line(!0)
    }, letter = function(e, i) {
        new t(e, i)
    }
}();
